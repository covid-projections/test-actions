...
execute () {
  curl -H "Authorization: token $GITHUB_TOKEN" \
      ...
      https://api.github.com/repos/covid-projections/test-actions/dispatches

  echo "Label requested. Go to https://github.com/covid-projections/test-actions/actions to monitor progress."
}
